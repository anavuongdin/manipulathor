...
from allenact.ithor_arm.ithor_arm_constants import TRAIN_OBJECTS, TEST_OBJECTS
from allenact.manipulathor_baselines.armpointnav_baselines.experiments.armpointnav_thor_base import (
